...
(deftest test-game-play-human-v-human
  (testing "Player one wins the game on a 3x3 board"
  (is (= true (string/includes?
         (with-out-str ""
           (with-in-str (make-input '("1" "1" "X" "O" "0" "5" "1" "4" "2")) 
            (game-runner/start))) "Player X wins!" )))))
  ...
  (is (= true (string/includes?
         (with-out-str ""
           (with-in-str (make-input '("1" "1" "X" "O" "1" "4" "2" "8" "7" "0")) 
            (game-runner/start))) "Player O wins!" )))))
  ...
  (is (= true (string/includes?
         (with-out-str ""
           (with-in-str (make-input '("1" "1" "x" "5" "p" "0" "4" "1" "3" "2")) 
            (game-runner/start))) "Invalid. Please pick another marker." )))))
  ...
  (is (= true (string/includes?
         (with-out-str ""
           (with-in-str (make-input '("3" "1" "1" "x" "p" "0" "4" "1" "3" "2"))
            (game-runner/start))) "Invalid. Please pick an available option." )))))
